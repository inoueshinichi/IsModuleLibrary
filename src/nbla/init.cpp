...
#include <nbla/function/log1p.hpp>
#include <nbla/function/log2.hpp>
#include <nbla/function/log10.hpp>
...
namespace Is
{
    namespace nbla
    {
        void init_cpu()
        {
            ...
            /*arange*/
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<bool>, "cpu:bool", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<uchar>, "cpu:ubyte", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<char>, "cpu:byte", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<ushort>, "cpu:ushort", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<short>, "cpu:short", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<uint>, "cpu:uint", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<uint>, "cpu:int", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<ulong>, "cpu:ulong", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<long>, "cpu:long", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<ulonglong>, "cpu:ulonglong", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<longlong>, "cpu:longlong", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<float>, "cpu:float", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<double>, "cpu:double", double, double, double)
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<longdouble>, "cpu:longdouble", double, double, double)
            ...
            /*broadcast*/
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<bool>, "cpu:bool", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<uchar>, "cpu:ubyte", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<char>, "cpu:byte", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<ushort>, "cpu:ushort", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<short>, "cpu:short", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<uint>, "cpu:uint", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<uint>, "cpu:int", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<ulong>, "cpu:ulong", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<long>, "cpu:long", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<ulonglong>, "cpu:ulonglong", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<longlong>, "cpu:longlong", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<float>, "cpu:float", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<double>, "cpu:double", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<longdouble>, "cpu:longdouble", const vector<int> &)
            ...
            /*flip*/
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<bool>, "cpu:bool", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<uchar>, "cpu:ubyte", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<char>, "cpu:byte", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<ushort>, "cpu:ushort", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<short>, "cpu:short", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<uint>, "cpu:uint", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<uint>, "cpu:int", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<ulong>, "cpu:ulong", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<long>, "cpu:long", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<ulonglong>, "cpu:ulonglong", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<longlong>, "cpu:longlong", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<float>, "cpu:float", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<double>, "cpu:double", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<longdouble>, "cpu:longdouble", const vector<int> &)
            ...
            /*max*/
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<bool>, "cpu:bool", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<uchar>, "cpu:ubyte", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<char>, "cpu:byte", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<ushort>, "cpu:ushort", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<short>, "cpu:short", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<uint>, "cpu:uint", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<uint>, "cpu:int", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<ulong>, "cpu:ulong", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<long>, "cpu:long", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<ulonglong>, "cpu:ulonglong", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<longlong>, "cpu:longlong", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<float>, "cpu:float", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<double>, "cpu:double", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<longdouble>, "cpu:longdouble", const vector<int> &, bool, bool, bool)
            ...
            /*mean*/
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<bool>, "cpu:bool", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<uchar>, "cpu:ubyte", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<char>, "cpu:byte", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<ushort>, "cpu:ushort", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<short>, "cpu:short", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<uint>, "cpu:uint", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<uint>, "cpu:int", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<ulong>, "cpu:ulong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<long>, "cpu:long", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<ulonglong>, "cpu:ulonglong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<longlong>, "cpu:longlong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<float>, "cpu:float", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<double>, "cpu:double", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<longdouble>, "cpu:longdouble", const vector<int> &, bool)

            /*min*/
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<bool>, "cpu:bool", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<uchar>, "cpu:ubyte", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<char>, "cpu:byte", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<ushort>, "cpu:ushort", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<short>, "cpu:short", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<uint>, "cpu:uint", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<uint>, "cpu:int", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<ulong>, "cpu:ulong", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<long>, "cpu:long", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<ulonglong>, "cpu:ulonglong", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<longlong>, "cpu:longlong", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<float>, "cpu:float", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<double>, "cpu:double", const vector<int> &, bool, bool, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<longdouble>, "cpu:longdouble", const vector<int> &, bool, bool, bool)
            ...
            /*prod*/
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<bool>, "cpu:bool", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<uchar>, "cpu:ubyte", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<char>, "cpu:byte", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<ushort>, "cpu:ushort", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<short>, "cpu:short", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<uint>, "cpu:uint", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<uint>, "cpu:int", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<ulong>, "cpu:ulong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<long>, "cpu:long", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<ulonglong>, "cpu:ulonglong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<longlong>, "cpu:longlong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<float>, "cpu:float", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<double>, "cpu:double", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Prod, Prod<longdouble>, "cpu:longdouble", const vector<int> &, bool)
            ...
            /*rand*/
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<bool>, "cpu:bool", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<uchar>, "cpu:ubyte", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<char>, "cpu:byte", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<ushort>, "cpu:ushort", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<short>, "cpu:short", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<uint>, "cpu:uint", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<uint>, "cpu:int", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<ulong>, "cpu:ulong", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<long>, "cpu:long", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<ulonglong>, "cpu:ulonglong", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<longlong>, "cpu:longlong", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<float>, "cpu:float", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<double>, "cpu:double", float, float, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<longdouble>, "cpu:longdouble", float, float, const vector<int> &, int)

            /*randint*/
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<bool>, "cpu:bool", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<uchar>, "cpu:ubyte", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<char>, "cpu:byte", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<ushort>, "cpu:ushort", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<short>, "cpu:short", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<uint>, "cpu:uint", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<uint>, "cpu:int", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<ulong>, "cpu:ulong", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<long>, "cpu:long", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<ulonglong>, "cpu:ulonglong", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<longlong>, "cpu:longlong", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<float>, "cpu:float", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<double>, "cpu:double", int, int, const vector<int> &, int)
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<longdouble>, "cpu:longdouble", int, int, const vector<int> &, int)
            
            /*randn*/
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<bool>, "cpu:bool", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<uchar>, "cpu:ubyte", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<char>, "cpu:byte", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<ushort>, "cpu:ushort", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<short>, "cpu:short", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<uint>, "cpu:uint", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<uint>, "cpu:int", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<ulong>, "cpu:ulong", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<long>, "cpu:long", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<ulonglong>, "cpu:ulonglong", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<longlong>, "cpu:longlong", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<float>, "cpu:float", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<double>, "cpu:double", float, float, const vector<int>& ,int)
            NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<longdouble>, "cpu:longdouble", float, float, const vector<int>& ,int)

            /*reshape*/
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<bool>, "cpu:bool", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<uchar>, "cpu:ubyte", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<char>, "cpu:byte", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<ushort>, "cpu:ushort", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<short>, "cpu:short", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<uint>, "cpu:uint", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<uint>, "cpu:int", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<ulong>, "cpu:ulong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<long>, "cpu:long", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<ulonglong>, "cpu:ulonglong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<longlong>, "cpu:longlong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<float>, "cpu:float", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<double>, "cpu:double", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Reshape, Reshape<longdouble>, "cpu:longdouble", const vector<int> &, bool)
           ...
           /*round*/
            ...
            /*slice*/
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<bool>, "cpu:bool", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<uchar>, "cpu:ubyte", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<char>, "cpu:byte", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<ushort>, "cpu:ushort", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<short>, "cpu:short", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<uint>, "cpu:uint", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<uint>, "cpu:int", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<ulong>, "cpu:ulong", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<long>, "cpu:long", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<ulonglong>, "cpu:ulonglong", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<longlong>, "cpu:longlong", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<float>, "cpu:float", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<double>, "cpu:double", const vector<int> &, const vector<int> &, const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<longdouble>, "cpu:longdouble", const vector<int> &, const vector<int> &, const vector<int> &)
            ...
            /*sum*/
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<bool>, "cpu:bool", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<uchar>, "cpu:ubyte", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<char>, "cpu:byte", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<ushort>, "cpu:ushort", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<short>, "cpu:short", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<uint>, "cpu:uint", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<uint>, "cpu:int", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<ulong>, "cpu:ulong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<long>, "cpu:long", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<ulonglong>, "cpu:ulonglong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<longlong>, "cpu:longlong", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<float>, "cpu:float", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<double>, "cpu:double", const vector<int> &, bool)
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<longdouble>, "cpu:longdouble", const vector<int> &, bool)
            ...
            /*transpose*/
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<bool>, "cpu:bool", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<uchar>, "cpu:ubyte", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<char>, "cpu:byte", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<ushort>, "cpu:ushort", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<short>, "cpu:short", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<uint>, "cpu:uint", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<uint>, "cpu:int", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<ulong>, "cpu:ulong", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<long>, "cpu:long", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<ulonglong>, "cpu:ulonglong", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<longlong>, "cpu:longlong", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<float>, "cpu:float", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<double>, "cpu:double", const vector<int> &)
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<longdouble>, "cpu:longdouble", const vector<int> &)
